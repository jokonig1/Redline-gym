...
// Tipografía redondeada y bien gruesa para el menú y los títulos — antes la
// landing caía en el fallback genérico (Arial) porque nunca se cargó ninguna
// fuente real.
  ...
  return (
    <div className="dark min-h-screen bg-background text-foreground">
          ...
          <div className="hidden md:flex items-center gap-7">
            {[
              ...
              <a key={href} href={href}
                className={`${poppins.className} text-sm uppercase tracking-wider text-zinc-400 hover:text-red-500 transition-colors font-semibold`}>
                {label}
              </a>
            ))}
          </div>
          ...
          <div className="md:hidden border-t border-border bg-surface px-4 py-3 space-y-1">
            {[
              ...
              <a key={href} href={href} onClick={() => setMenuOpen(false)}
                className={`${poppins.className} block py-2.5 text-sm uppercase tracking-wider font-semibold text-zinc-400 hover:text-red-500 transition-colors`}>
                {label}
              </a>
            ))}
            <a href={waLink} target="_blank" rel="noopener noreferrer"
              onClick={() => setMenuOpen(false)}
              className={`${poppins.className} block py-2.5 text-sm uppercase tracking-wide font-bold text-red-500`}>
              Clase de prueba gratis →
            </a>
          </div>
        )}
      ...
      <section id="inicio" className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 pt-16">
        {/* Imagen de fondo — foto real del gimnasio, servida optimizada por Next.js */}
        <div className="absolute inset-0 z-0">
          <Image
            ...
            quality={90}
            sizes="100vw"
            className="object-cover object-[center_10%] brightness-105 contrast-105"
          />
          {/* Overlay oscuro para legibilidad del texto */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/35 via-black/45 to-black/65" />
        </div>
        <div className="relative z-10 max-w-3xl mx-auto">
          <div className={`${poppins.className} inline-flex items-center gap-2 text-xs sm:text-sm font-bold uppercase tracking-[2px] text-white mb-8 px-5 py-2.5 rounded-full bg-red-600 shadow-lg shadow-red-600/30`}>
            Entrenamiento · Rehabilitación · Bienestar
          </div>

          <h1 className={`${poppins.className} text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-none mb-6 text-foreground`}>
            No entrenas solo<br />
      ...
      {/* ── SOBRE NOSOTROS ── */}
      <section id="nosotros" className="py-28 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className={`${poppins.className} space-y-4 text-zinc-300 leading-relaxed text-sm sm:text-base`}>
                <p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="bg-surface border border-border rounded-2xl p-6 text-center transition-all hover:-translate-y-1 hover:border-red-600/30 hover:shadow-lg hover:shadow-red-600/5">
                  <div className={`${poppins.className} text-2xl sm:text-3xl font-bold text-red-600 mb-1`}>{valor}</div>
      ...
      {/* ── SERVICIOS — bloque sólido de color, para que el fondo cambie al bajar ── */}
      <section id="servicios" className="py-28 px-4 bg-red-600">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Musculación */}
            <div className="bg-black border border-black/40 rounded-2xl p-7 transition-all hover:-translate-y-1 hover:bg-zinc-900">
              <div className="w-16 h-16 rounded-full bg-red-600 flex items-center justify-center mb-5 p-3">
      ...
      <section id="planes" className="py-28 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Plan Personalizado */}
            <div className="bg-red-600 rounded-2xl p-7 text-white relative overflow-hidden transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-red-600/20">
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    <div key={f} className="flex items-center justify-between bg-white/10 rounded-xl px-4 py-2.5">
                      ...
                      <span className={`${poppins.className} text-sm font-bold`}>{p}/mes</span>
                    </div>
                  ))}
                </div>
                <a href={waLink} target="_blank" rel="noopener noreferrer"
                  className={`${poppins.className} block text-center bg-white text-red-600 uppercase tracking-wide font-bold py-3 rounded-xl hover:bg-red-50 transition-colors text-sm`}>
                  Consultar →
                </a>
              </div>
            </div>
            ...
            <div className="bg-surface border border-border rounded-2xl p-7 transition-all hover:-translate-y-1 hover:border-border-strong hover:shadow-xl hover:shadow-black/20">
              <div className="inline-block text-[10px] font-bold uppercase tracking-widest text-zinc-400 bg-hover-md px-3 py-1 rounded-full mb-3">Grupos reducidos</div>
              <h3 className={`${poppins.className} text-xl font-bold text-foreground mb-1`}>Plan Semi Personalizado</h3>
              <p className={`${poppins.className} text-zinc-300 text-sm mb-6`}>
              ...
              <div className="space-y-3 mb-6">
                {[
                  ...
                  <div key={f} className="flex items-center justify-between bg-hover border border-border rounded-xl px-4 py-2.5">
                    ...
                    <span className={`${poppins.className} text-sm font-bold text-foreground`}>{p}/mes</span>
                  </div>
                ))}
              </div>
              <a href={waLink} target="_blank" rel="noopener noreferrer"
                className={`${poppins.className} block text-center border border-border-strong text-foreground hover:bg-hover-md uppercase tracking-wide font-bold py-3 rounded-xl transition-colors text-sm`}>
                Consultar →
              </a>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
            ...
            <a href={mapsLink} target="_blank" rel="noopener noreferrer"
              className="block bg-background border border-border rounded-2xl p-7 text-center transition-all hover:-translate-y-1 hover:border-red-600/40 hover:shadow-xl hover:shadow-red-600/5">
              <div className="w-14 h-14 rounded-full bg-zinc-900 flex items-center justify-center mx-auto mb-4 border border-zinc-700">
